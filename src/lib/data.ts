...
export const seedListings: Listing[] = [
  { id: 1, name: 'Mbare Greenbelt Plot', area: 'Harare South, Harare', size: '2.4 hectares', price: '$180 / season', detail: 'Jun - Nov 2026', crop: 'Leafy greens', image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?auto=format&fit=crop&w=1000&q=85', tags: ['Borehole', 'Fenced'], featured: true, description: 'A well-drained greenbelt plot with a working borehole and full perimeter fencing. Previous seasons grew rape, covo and spinach for the Mbare market.' },
  { id: 2, name: 'Chitungwiza Orchard Land', area: 'Manyame, Mashonaland East', size: '1.8 hectares', price: '$95 / month', detail: 'Flexible term', crop: 'Horticulture', image: 'https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=1000&q=85', tags: ['Irrigation', 'Storage'], description: 'Established drip irrigation lines across gently sloping land, with a lockable storage shed on site for tools and harvest.' },
  { id: 3, name: 'Borrowdale Smallholding', area: 'Borrowdale, Harare', size: '0.75 hectares', price: '$75 / month', detail: '12 month lease', crop: 'Herbs & vegetables', image: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=1000&q=85', tags: ['Shed', 'Power nearby'], description: 'A compact, easy-to-manage plot close to the city, suited to herbs and market vegetables. Grid power is available at the boundary.' },
  { id: 4, name: 'Norton River Flats', area: 'Norton, Mashonaland West', size: '4.1 hectares', price: '$260 / season', detail: 'Jun - Nov 2026', crop: 'Maize & beans', image: 'https://images.unsplash.com/photo-1530507629858-e4977d30e9e0?auto=format&fit=crop&w=1000&q=85', tags: ['River access', 'Tilled'], description: 'Flat, already-tilled river-flat land with direct water access, previously used for a maize and bean rotation.' },
]
